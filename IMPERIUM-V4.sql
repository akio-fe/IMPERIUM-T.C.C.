...
-- Copiando dados para a tabela imperium.enderecoentrega: ~1 rows (aproximadamente)
...
INSERT INTO `enderecoentrega` (`EndEntId`, `EndEntRef`, `EndEntRua`, `EndEntCep`, `EndEntNum`, `EndEntBairro`, `EndEntCid`, `EndEntEst`, `EndEntComple`, `UsuId`) VALUES
	(2, 'casa', 'Rua Aníbal dos Anjos Carvalho', '04810-050', 151, 'Vila Santa Maria', 'São Paulo', 'SP', 'casa 11', 1);
...
-- Copiando dados para a tabela imperium.favorito: ~2 rows (aproximadamente)
